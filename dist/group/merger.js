 ...
 * - 队列中有多个消息
 */
export function shouldMergeMessages(messages, groupOpenid, mergeWindowMs = 5000) {
 ...
 * @returns 合并后的完整消息体
 */
export function mergeGroupMessages(messages, atYouTag = false) {
