 ...
 * 检测消息是否 @了机器人
 */
export function detectWasMentioned(input) {
 ...
 */
export function hasAnyMention(input) {
    const { mentions, content } = input;
    if (mentions && mentions.length > 0)
        return true;
    if (content && MENTION_TAG_RE.test(content))
        return true;
    return false;
}
/**
...
//# sourceMappingURL=mention-detector.js.map